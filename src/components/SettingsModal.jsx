...
import { X, Settings, LogOut, Shield, Bell, Moon, Sun, AlertCircle, CheckCircle } from 'lucide-react'
          ...
          <div className="flex items-center justify-between p-6 border-b border-gray-200 dark:border-gray-700">
            <div className="flex items-center space-x-3">
              ...
              <div>
                ...
                <p className="text-sm text-gray-500 dark:text-gray-400">계정 및 앱 설정</p>
              </div>
            </div>
            <motion.button
